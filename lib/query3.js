...
import { _funcs, fgroups, _funcs_extra } from "./funcs"
...
export const getElm = (v, ids = {}, tags = { tags: [] }) => {
  ...
  if (allPass([complement(isNil), complement(is)(String), is(Array)])(v)) {
    const hhh = __i++
    console.log("....................hhhh[" + hhh + "]", v)
    const g = get(v)
    console.log("....................hhhh[" + hhh + "]", g.f, g.tags, tags, v)
    let i = 0
    tags.tags = g.tags
    /*
    for (let v2 of g.tags) {
      tags[i] = v2
      i++
      }*/
    console.log("....................hhhh[" + hhh + "]", tags)
    return g.f
  }
  ...
  switch (elm) {
    ...
    case "fn": {
      ...
      console.log(func, arg, index, funcs[func])
      _elm = compose(
        prop("f"),
        tap(g => {
          console.log("here...", g, tags, v)
          if (is(Array)(g.tags[0])) {
            g.tags[0][0] = v
          } else {
            g.tags[0] = v
          }
          console.log("comp", tags, g.tags)
          /*
          let i = tags.length
          for (let v2 of g.tags) {
            tags[i] = v2
    ...
    case "[fg]": {
      ...
      _elm = map(v => {
        ...
        console.log("very motherfucker.......................", v)
...
export const get = arr => {
  ...
  if (is(Array)(arr)) {
    ...
    arr2 = map(v => {
      let _tags = { tags: [] }
      let g = getElm(v, ids, _tags)
      console.log("check2....", v)
      console.log(g, _tags)
      tags.push(_tags.tags)
      return g
    })([arr + "-0"])[0]
    tags = tags[0]
    console.log("this is not arr", tags)
  }
  console.log(
    "vals.............................................................." + _iii,
    arr
  )
  //if (is(Array)(arr)) tags = [tags]
